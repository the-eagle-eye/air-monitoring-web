...
export const USERS = {
  admin: { email: 'admin@oefa.gob.pe', password: 'admin123', rol: 'administrador' },
  tecnico: { email: 'tecnico1@oefa.gob.pe', password: 'tecnico123', rol: 'tecnico' },
  coordinador: { email: 'coordinador1@oefa.gob.pe', password: 'coord123', rol: 'coordinador' },
};
...
export async function injectFakeAuth(
  ...
  const fakeUser = { id: 1, email: 'admin@oefa.gob.pe', nombre: 'Test', apellido: 'User', rol };
