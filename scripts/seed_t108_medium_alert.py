"""
Seed moderately degraded readings for T108 to produce alerta MEDIA (RUL 30-59 dias).
...
Usage:
    python scripts/seed_t108_medium_alert.py [--url URL] [--db DB_URL]
"""
...
N_READINGS = 300
# Moderate degradation: progress from 0.60 to 0.75 (mid-lifecycle, targets RUL 30-59)
PROGRESS_START = 0.60
PROGRESS_END = 0.75
...
def main():
    parser = argparse.ArgumentParser(description="Seed moderately degraded readings for T108 (alerta media)")
    parser.add_argument(
        "--url",
