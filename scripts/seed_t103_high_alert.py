"""
Seed critically degraded readings for T103 to produce alerta ALTA (RUL < 30 dias).
...
Usage:
    python scripts/seed_t103_high_alert.py [--url URL] [--db DB_URL]
"""
...
def main():
    parser = argparse.ArgumentParser(description="Seed critically degraded readings for T103 (alerta alta)")
    parser.add_argument(
        "--url",
