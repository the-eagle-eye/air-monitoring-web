"""
Seed critically degraded readings for T105 to produce alerta ALTA (RUL < 30 dias).
...
Usage:
    python scripts/seed_t105_high_alert.py [--url URL] [--db DB_URL]
"""
...
def main():
    parser = argparse.ArgumentParser(description="Seed critically degraded readings for T105 (alerta alta)")
    parser.add_argument(
        "--url",
